<template>
  <div class="paginator-container">
    ...
    <div class="pages">
      <base-icon @click="previousPage" :icon-path="caretLeftIcon" :width="'20px'"/>
      ...
      <base-icon @click="nextPage" :icon-path="caretRightIcon" :width="'20px'"/>
    </div>
  </div>
</template>
...
function nextPage() {
  if (props.pageNumber < numberOfPages.value) {
    emit('pageChange', props.pageNumber + 1);
  }
}
